...
var ASM_CONSTS = [function() { let luaScript = document.querySelector("script[type='text/lua']"); let xhr = new XMLHttpRequest(); xhr.onload = function(){ FS.writeFile("/app.lua",xhr.responseText); ccall("luaLoaded"); }; xhr.open("get",luaScript.src); xhr.send(); }];
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=20064;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var ___tm_current=20112;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 20160, 4), 20160);function _gmtime_r(time, tmPtr) {
...
var real__luaLoaded = asm["_luaLoaded"]; asm["_luaLoaded"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__luaLoaded.apply(null, arguments);
};
...
var _luaLoaded = Module["_luaLoaded"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_luaLoaded"].apply(null, arguments) };
